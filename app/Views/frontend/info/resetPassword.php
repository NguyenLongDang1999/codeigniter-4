...
<div class="container-fluid mb-3 p-0">
    <div class="breadcrumbs">
        <div class="breadcrumbs__title">Đổi mật khẩu</div>
    </div>
</div>
<?= $this->endSection() ?>
...
<div class="row">
    <div class="col-12">
        <div class="bill-detail">
            ...
            <?php } ?>
            <h4 class="text-uppercase text-center">Đổi mật khẩu</h4>
            <?= form_open(base_url(route_to('infoPostResetPassword', $row['id'])), ['class' => 'mt-3 mb-3']) ?>
            <?= csrf_field() ?>

            <div class="form-row d-flex justify-content-center">
                <div class="form-group col-md-4">
                    <label for="inputEmail4">Mật khẩu cũ <span class="text-danger">(*)</span></label>
                    <input type="password" name="password" class="form-control border-radius-0 <?= ($validation->getError('password')) ? 'is-invalid' : '' ?>" id="inputEmail4">
                    <p class="text-danger mb-0 text-capitalize"><?= $validation->getError('password');  ?></p>
                </div>
            </div>
            <div class="form-row d-flex justify-content-center">
                <div class="form-group col-md-4">
