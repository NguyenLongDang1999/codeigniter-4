...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title text-capitalize">Xem danh sách coupon</h4>
        </div>
    </div>
</div>
<!-- end page title -->
...
<div class="row">
    <div class="col-12">
        ...
        <a href="<?= base_url(route_to('couponAdd')) ?>" class="btn btn-success waves-effect waves-light mb-2 text-capitalize">Thêm mới <i class="mdi mdi-plus-box"></i></a>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($list as $item) { ?>
                            ...
                            <tr>
                                <td><?= $no++ ?></td>
                                <td><?= $item['code'] ?></td>
                                <td><a href="<?= base_url(route_to('couponStatus', $item['id'])) ?>"><?= $status ?></a></td>
                                <td><?= $item['created_at'] ?></td>
                                <td>
                                    <a href="<?= base_url(route_to('couponEdit', $item['id'])) ?>" class="btn btn-xs btn-secondary"><i class="mdi mdi-pencil"></i></a>
                                    <a href="<?= base_url(route_to('couponDelete', $item['id'])) ?>" onclick="return confirm('Bạn có chắn chắn muốn xóa coupon này không ?')" class="btn btn-xs btn-danger"><i class="mdi mdi-trash-can-outline"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
