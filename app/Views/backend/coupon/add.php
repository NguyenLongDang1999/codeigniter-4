...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title text-capitalize">Thêm mới coupon</h4>
        </div>
    </div>
</div>
<!-- end page title -->
...
<?= form_open(base_url(route_to('couponPostAdd'))) ?>
<?= csrf_field() ?>
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= ($validation->getError('code')) ? 'parsley-error' : '' ?>" value="<?= set_value('code') ?>" name="code" placeholder="">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= ($validation->getError('price_discount')) ? 'parsley-error' : '' ?>" value="<?= set_value('price_discount') ?>" name="price_discount" placeholder="">
                    <ul class="list-unstyled mt-1">
        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= ($validation->getError('code_limit')) ? 'parsley-error' : '' ?>" value="<?= set_value('code_limit') ?>" name="code_limit" placeholder="">
                    <ul class="list-unstyled mt-1">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control datepicker <?= ($validation->getError('expiration_date')) ? 'parsley-error' : '' ?>" name="expiration_date" data-provide="datepicker" value="<?= set_value('expiration_date') ?>" data-date-autoclose="true">
        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= ($validation->getError('price_payment_limit')) ? 'parsley-error' : '' ?>" value="<?= set_value('price_payment_limit') ?>" name="price_payment_limit" placeholder="">
                    <ul class="list-unstyled mt-1">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?= ($validation->getError('code_description')) ? 'parsley-error' : '' ?>" value="<?= set_value('code_description') ?>" name="code_description" placeholder="">
                    <ul class="list-unstyled mt-1">
