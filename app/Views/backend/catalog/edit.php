...
<?= form_open_multipart(base_url(route_to('catalogPostEdit', $row['id']))) ?>
<?= csrf_field() ?>
        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="file" class="dropify" name="thumb" data-default-file="<?= ($row['thumb'] == 'default-image.jpg') ? base_url('uploads/' . $row['thumb']) : base_url('uploads/catalog/' . $row['thumb']) ?>">
                    <ul class="list-unstyled mt-1">
