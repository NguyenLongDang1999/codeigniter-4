                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mt-3 text-center">
                            ...
                            <h3 class="text-capitalize">Đặt hàng thành công !</h3>
                            <p class="text-muted mt-2"> Đơn hàng của bạn đã được gửi tới Email <span class="font-weight-medium"><?= session()->has('userEmail') ? session()->get('userEmail') : '' ?></span>.
                                Vui lòng kiểm tra lại đơn hàng. Chúng tôi sẽ liên lạc với quý khách để vận chuyển đơn hàng này sớm nhất. </p>

                            <a href="<?= base_url() ?>" class="btn btn-block btn-primary waves-effect waves-light mt-3">Về Trang Chủ</a>
                        </div>
