...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            ...
            <h4 class="page-title text-capitalize">Cập nhật tin tức</h4>
        </div>
    </div>
</div>
<!-- end page title -->
...
<?= form_open_multipart(base_url(route_to('postPostEdit', $row['id']))) ?>
<?= csrf_field() ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="file" class="dropify" name="thumb" data-default-file="<?= ($row['thumb'] == 'default-image.jpg') ? base_url('uploads/' . $row['thumb']) : base_url('uploads/post/' . $row['thumb']) ?>">
                                <ul class="list-unstyled mt-1">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="catpostid">
                                    <?php foreach ($catalog_subcat as $item) { ?>
                                        <?php if ($row['catpostid'] == $item['id']) { ?>
                                            <option value="<?= $item['id'] ?>" selected <?= set_select('catpostid', $item['id']) ?>><?= $item['name'] ?></option>
                                        <?php } else { ?>
                                        ...
                                        <?php if (count($catalog_subcat2)) { ?>
                                            <?php foreach ($catalog_subcat2 as $item2) { ?>
                                                <?php if ($row['catpostid'] == $item2['id']) { ?>
                                                    <option value="<?= $item2['id'] ?>" selected <?= set_select('catpostid', $item2['id']) ?>> - - - <?= $item2['name'] ?></option>
                                                <?php } else { ?>
                                                ...
                                                <?php if (count($catalog_subcat3)) { ?>
                                                    <?php foreach ($catalog_subcat3 as $item3) { ?>
                                                        <?php if ($row['catpostid'] == $item3['id']) { ?>
                                                            <option value="<?= $item3['id'] ?>" selected <?= set_select('catpostid', $item3['id']) ?>> - - - - - - <?= $item3['name'] ?></option>
                                                        <?php } else { ?>
